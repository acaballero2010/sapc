...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={inter.variable} suppressHydrationWarning>
      ...
      <body className={`${inter.className} min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 antialiased selection:bg-amber-100 selection:text-amber-900 font-sans transition-colors duration-200`}>
        <ThemeProvider>
          <LanguageProvider>
            <AuthProvider>
              <ToastProvider>
