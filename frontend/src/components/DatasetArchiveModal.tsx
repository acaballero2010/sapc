...
export const DatasetArchiveModal: React.FC<DatasetArchiveModalProps> = ({
  ...
  const downloadMasterJson = () => {
    ...
    showToast("Master 500-student database archive downloaded successfully!");
  };
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Easily archive, download, snapshot, or restore sample datasets and 5-domain templates
              </p>
            </div>
          </div>
          <button 
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <h4 className="font-extrabold text-sm text-slate-900 dark:text-white">
                        Full 500-Student Database Bundle
                      </h4>
                      <p className="text-xs text-slate-500 dark:text-slate-400">
                        Complete JSON export containing all student profiles, GPA, absences, and 5-domain scores.
                      </p>
                    </div>
                  </div>
                  <button
                    onClick={downloadMasterJson}
                    className="px-4 py-2 rounded-xl bg-[#8B0014] hover:bg-[#700010] text-white text-xs font-bold transition flex items-center gap-1.5 shadow-2xs cursor-pointer"
                  >
                    <Download className="h-4 w-4" />
                ...
                >
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <button
                      ...
                      className="p-2 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:bg-slate-100 text-slate-600 dark:text-slate-300 text-xs font-bold"
                    >
                      <Download className="h-4 w-4" />
                    </button>
                    {onRestoreSnapshot && (
                      <button
                        ...
                        className="px-3 py-2 rounded-xl bg-rose-50 dark:bg-rose-950 text-[#8B0014] dark:text-rose-300 border border-rose-200 dark:border-rose-900 text-xs font-bold flex items-center gap-1"
                      >
