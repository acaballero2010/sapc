...
const DEFAULT_FLAGGED_ALERTS: FlaggedAlert[] = [
  {
    ...
    grade_section: "Grade 7 - St. Anthony",
    aggregate_distress_score: 88,
    severity: "urgent",
    keyword_detected: "gusto ko na sumuko / I want to give up",
    flag_reason: "Student expressed severe academic helplessness, panic over impending examinations, and chronic insomnia.",
    transcript_snippet: "Student: 'Sobrang bigat na po ng mga aralin. Hindi ko na po kaya, gusto ko na sumuko... parang burden lang ako sa magulang ko.'\nAI Bot: 'Naiintindihan ko na mabigat ang nararamdaman mo, Erika. Nandito ako para makinig at hindi ka nag-iisa. Pwede ba kitang ikonekta kay Ma'am Maria Theresa Cruz sa Guidance Office para matulungan ka?'\nStudent: 'Opo, kailangan ko po ng tulong.'",
  ...
  },
  {
    ...
    grade_section: "Grade 7 - St. Bernadette",
  ...
  },
  {
    ...
    grade_section: "Grade 7 - St. Francis",
    aggregate_distress_score: 62,
    severity: "watchlist",
    keyword_detected: "laging pagod / exhausted",
    flag_reason: "Reported difficulty balancing family responsibilities with daytime academic schedule.",
    transcript_snippet: "Student: 'Pagod na pagod ako pumasok araw-araw galing sa pag-alaga ng mga kapatid.'\nAI Bot: 'Nakakahanga ang malasakit mo sa pamilya, Angelica, pero mahalaga rin ang kalusugan at pahinga mo. May academic and peer support programs tayo sa guidance center.'",
...
export const CounselorDashboard: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined") {
      ...
      const handleCustomNav = (e: CustomEvent<{ tab?: CounselorTabType; hash?: string; source?: string }>) => {
